...
router.post('/logout', decode, logout)
router.post('/verify',decode, verify)         //门票验证
router.post('/use', decode, use)              //使用门票
router.post('/query', decode, query)          //订单查询
router.post('/info', decode, info)            //获取信息
router.post('/rest', rest)                    //修改密码
router.post('/register', register)            //注册
router.post('/Validate', decode, Validate)    //验证
